...
const siteUrl = "https://dietrixfit.com";
const targetMarkets = [
  "Pakistan",
  "United Kingdom",
  "England",
...
// The sitemap moved to /sitemap_index.xml for a period to shed a
// failed-fetch history in Search Console tied to /sitemap.xml on the old
// dietrix.fit domain. Migrating to dietrixfit.com is itself a clean slate
// for that history, so the sitemap is restored to the conventional path.
